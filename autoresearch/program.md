...
|-----------|--------|-----------------|----------------|
| **Elevation Accuracy** | 25% | ElevationRouter correctly escalates hard queries to Buddhi and lets easy ones through Manas | Tune `elevation_threshold`, `manas_temp`, `buddhi_temp` |
...
- **Elevation collapse**: router always outputs 0 or always 1 → efficiency = 0, penalized heavily
...
- Elevation accuracy is 25% of the score — the router is the highest-leverage component
